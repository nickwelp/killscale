...
const HelpText = () => {
    const { showHelp, setShowHelp } = useContext(MyUserContext);
    return (
        <>
            <div style={{ background: '#F2F2F2', padding: '2px 2px 10px 10px', marginBottom: '0', display: 'flex', flexFlow: 'row', justifyContent: 'space-between' }}>
                <h2>Help </h2>
                <label>close Help<input checked={showHelp} type={'checkbox'} onChange={(e: ChangeEvent<HTMLInputElement>) => setShowHelp(!!e.currentTarget.checked)} /></label>
            </div>
            <div style={{ fontFamily: 'serif', fontSize: '14px', padding: '20px', background: '#F2F2F2' }}>
                ...
                <blockquote style={{ margin: '20px', padding: '10px', background: '#DDDDDD' }}>
