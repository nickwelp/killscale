    ...
    return (
        <>
            <div style={{ background: '#F2F2F2', padding: '2px 2px 10px 10px', marginBottom: '0', display: 'flex', flexFlow: 'row', justifyContent: 'space-between' }}>
                <h2>Options </h2>
                <label>close Options<input checked={showOptions} type={'checkbox'} onChange={(e: ChangeEvent<HTMLInputElement>) => setShowOptions(!!e.currentTarget.checked)} /></label>
            </div>
            <div style={{ background: '#F2F2F2', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', margin: '0px auto 10px auto', padding: '10px' }}>
